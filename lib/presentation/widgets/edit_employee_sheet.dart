        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Text("Editar Información del Empleado", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                IconButton(
            ...
            Row(
              children: [
                ...
                Expanded(child: _buildTextField("Apellido Paterno", _paternoCtrl)),
                const SizedBox(width: 15),
                Expanded(child: _buildTextField("Apellido Materno", _maternoCtrl)),
              ],
            ),
            ...
            Row(
              children: [
                Expanded(flex: 1, child: _buildTextField("Cédula de Identidad (CI)", _ciCtrl)),
                const SizedBox(width: 15),
                Expanded(flex: 2, child: _buildTextField("Cargo", _cargoCtrl)),
                const SizedBox(width: 15),
                Expanded(flex: 2, child: _buildTextField("Unidad / Sección", _unidadCtrl)),
              ],
            ),
