      ...
      cells: [
        ...
        DataCell(
          Padding(
            ...
            child: CircleAvatar(
              ...
              child: emp.photoUrl.isEmpty ? const Icon(Icons.person, size: 20, color: Colors.grey) : null,
            ),
          ),
        ),
        ...
        DataCell(
          Column(
            ...
            children: [
              Text(emp.nombreCompleto, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
            ],
          )
        ),
        ...
        DataCell(
          Row(
            mainAxisSize: MainAxisSize.min, // Importante para que no ocupen espacio infinito
            children: [
              // Ver
              _ActionButton(
