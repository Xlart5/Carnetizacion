...
class PdfGeneratorService {
  ...
  static Future<Uint8List> generateCredentialsPdf(List<Employee> employees) async {
    ...
    // 1. CARGAR ASSETS
    final templateFront = await _loadAsset('assets/images/card_template_front.png');
    final templateBack = await _loadAsset('assets/images/ATRAS_EVENTUAL_2025.png');
    final logoTed = await _loadAsset('assets/images/logo_ted.png'); 
    final logoElecciones = await _loadAsset('assets/images/logo_elecciones.png'); 
        ...
        pw.Page(
          ...
          build: (pw.Context context) {
            return pw.GridView(
              ...
              crossAxisSpacing: 10, 
              mainAxisSpacing: 5,  // Espacio vertical mínimo para que entren 5 filas
  ...
  static Future<pw.MemoryImage> _loadAsset(String path) async {
    try {
      ...
      return pw.MemoryImage(Uint8List.fromList([0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, 0x00, 0x00, 0x00, 0x0D, 0x49, 0x48, 0x44, 0x52, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x08, 0x06, 0x00, 0x00, 0x00, 0x1F, 0x15, 0xC4, 0x89, 0x00, 0x00, 0x00, 0x0A, 0x49, 0x44, 0x41, 0x54, 0x78, 0x9C, 0x63, 0x00, 0x01, 0x00, 0x00, 0x05, 0x00, 0x01, 0x0D, 0x0A, 0x2D, 0xB4, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4E, 0x44, 0xAE, 0x42, 0x60, 0x82]));
    }
  }
          ...
          pw.Positioned(
            ...
            child: pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  pw.Text("Ci: ${emp.ci}", style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 5)),
          ...
          pw.Positioned(
            ...
            child: pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  pw.Text("Personal Eventual", style: pw.TextStyle(color: PdfColors.white, fontSize: 6.5, fontWeight: pw.FontWeight.bold)),
                  pw.Text("Elecciones Subnacionales", style: pw.TextStyle(color: PdfColors.white, fontSize: 5.5)),
                ],
              ),
            ),
          ),
